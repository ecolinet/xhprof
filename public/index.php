...
if (!defined('XHPROF_LIB_ROOT')) {
    define('XHPROF_LIB_ROOT', dirname(__FILE__) . '/../library');
}
...
/*
 * reset params to be a array of variable names to values by the end of this page, param should only contain values that need to be preserved for the next page. unset all unwanted keys in $params.
 */
...
$domainsRS = $xhprof_runs_impl->getDistinct(array(
    'column' => 'server name'
));
$domainFilterOptions = array(
    "None"
);
...
$serverRS = $xhprof_runs_impl->getDistinct(array(
    'column' => 'server_id'
));
$serverFilterOptions = array(
    "None"
);
